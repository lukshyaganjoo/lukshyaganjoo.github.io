...
&\substack{\mathbf{R} \\ \mapsto} - \frac{1}{\sqrt{N}} \left(\frac{2 - N}{N} \ket{G} + \frac{2\sqrt{N - 1}}{N} \ket{B}\right) + \sqrt{\frac{N - 1}{N}} \left(\frac{2 \sqrt{N - 1}}{N} \ket{G} + \frac{N - 2}{N} \ket{B}\right) \\
